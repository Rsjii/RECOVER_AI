...
const Terms: React.FC = () => {
  useEffect(() => { document.title = 'Terms of Service — CashOS'; }, []);
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-[#09090b]">
      <div className="max-w-4xl mx-auto px-6 py-12">
        ...
        <p className="mt-4 text-sm text-gray-700 dark:text-gray-300 leading-relaxed">
          These Terms of Service ("Terms") constitute a legally binding agreement between you ("Customer," "you," or "your") and CashOS, Inc. ("CashOS," "we," "us," or "our") governing your access to and use of the CashOS platform, including all related APIs, integrations, and services (collectively, the "Service"). By creating an account or using the Service, you agree to be bound by these Terms.
        </p>
        ...
        <p className="text-sm text-gray-700 dark:text-gray-300 leading-relaxed">
          CashOS provides an intelligent accounts receivable (AR) recovery platform for B2B SaaS companies. The Service uses artificial intelligence to generate and send dunning communications to your customers with overdue invoices, offer structured payment plans, and track payment status through integrations with your billing and payment infrastructure. Once you configure your recovery policies and automation settings, the Service executes these policies according to your specifications. You retain full control over all automation settings, escalation policies, and can disable, pause, or modify any automated recovery workflow at any time. The Service integrates with third-party platforms including Stripe, QuickBooks, and Chargebee to synchronize invoice and payment data.
        </p>
