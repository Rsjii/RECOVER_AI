          ...
          <table className="w-full text-sm border border-gray-200 dark:border-gray-700 rounded-lg">
            <thead>
              <tr className="bg-gray-100 dark:bg-gray-800">
                <th className="text-left px-4 py-2.5 text-gray-900 dark:text-gray-100 font-medium border-b border-gray-200 dark:border-gray-700">Cookie Name</th>
                ...
                <th className="text-left px-4 py-2.5 text-gray-900 dark:text-gray-100 font-medium border-b border-gray-200 dark:border-gray-700">Duration</th>
                <th className="text-left px-4 py-2.5 text-gray-900 dark:text-gray-100 font-medium border-b border-gray-200 dark:border-gray-700">Type</th>
              </tr>
            </thead>
