...
const CookiePolicy: React.FC = () => {
  useEffect(() => { document.title = 'Cookie Policy — CashOS'; }, []);
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-[#09090b]">
      <div className="max-w-4xl mx-auto px-6 py-12">
        ...
        <p className="mt-4 text-sm text-gray-700 dark:text-gray-300 leading-relaxed">
          This Cookie Policy explains how CashOS, Inc. ("CashOS," "we," "us," or "our") uses cookies and similar tracking technologies when you visit or use our platform. This policy should be read alongside our Privacy Policy, which describes how we handle personal data more broadly.
        </p>
        ...
        <p className="text-sm text-gray-700 dark:text-gray-300 leading-relaxed">
          Some browsers offer a "Do Not Track" (DNT) signal that indicates you do not wish to be tracked. CashOS honors DNT signals. When we detect a DNT signal, we disable all non-essential cookies and analytics tracking for that session. We do not engage in cross-site tracking regardless of the DNT setting.
        </p>
        ...
        <p className="text-sm text-gray-700 dark:text-gray-300 leading-relaxed">
          If you have questions about our use of cookies or this Cookie Policy, please contact us at privacy@recoverai.com or by mail at CashOS, Inc., 1209 Orange Street, Wilmington, DE 19801, United States.
        </p>
