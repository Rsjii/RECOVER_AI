...
const Dpa: React.FC = () => {
  useEffect(() => { document.title = 'Data Processing Addendum — CashOS'; }, []);
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-[#09090b]">
      <div className="max-w-4xl mx-auto px-6 py-12">
        ...
        <p className="mt-4 text-sm text-gray-700 dark:text-gray-300 leading-relaxed">
          This Data Processing Addendum ("DPA") forms part of the agreement between you ("Customer," "Controller") and CashOS, Inc. ("CashOS," "Processor") governing the processing of personal data in connection with the CashOS platform (the "Service"). This DPA applies to the extent that CashOS processes personal data on behalf of the Customer in the course of providing the Service, and supplements the Terms of Service and Privacy Policy.
        </p>
        ...
        <p className="text-sm text-gray-700 dark:text-gray-300 leading-relaxed mb-2">
          <span className="font-medium text-gray-900 dark:text-gray-100">"Processor"</span> means the entity that processes personal data on behalf of the Controller. CashOS acts as the Processor when handling Customer's end-user data to provide the Service.
        </p>
        <p className="text-sm text-gray-700 dark:text-gray-300 leading-relaxed mb-2">
        ...
        <p className="text-sm text-gray-700 dark:text-gray-300 leading-relaxed">
          <span className="font-medium text-gray-900 dark:text-gray-100">"Sub-processor"</span> means any third party engaged by CashOS to process Personal Data on behalf of the Customer in connection with the Service.
        </p>
        ...
        <p className="text-sm text-gray-700 dark:text-gray-300 leading-relaxed mb-3">
          CashOS processes Personal Data solely to provide the intelligent accounts receivable recovery Service as described in the Terms of Service, according to Customer-configured policies and automation settings. The specific processing activities include:
        </p>
        ...
        <p className="text-sm text-gray-700 dark:text-gray-300 leading-relaxed mt-3">
          The categories of Personal Data processed include: names, email addresses, business names, invoice amounts, payment histories, billing addresses, and communication records. CashOS does not process sensitive personal data (e.g., health data, racial or ethnic origin) unless inadvertently included in invoice descriptions by the Customer.
        </p>

        <h2 className="text-xl font-semibold text-gray-900 dark:text-white mt-8 mb-3">3. Obligations of the Processor</h2>
        <p className="text-sm text-gray-700 dark:text-gray-300 leading-relaxed">
          CashOS shall process Personal Data only on documented instructions from the Customer, unless required by applicable law to do otherwise (in which case CashOS shall inform the Customer of that legal requirement before processing, unless prohibited by law). CashOS shall ensure that persons authorized to process Personal Data have committed themselves to confidentiality or are under an appropriate statutory obligation of confidentiality. CashOS shall take all reasonable steps to ensure that Personal Data is processed in accordance with this DPA and applicable data protection laws.
        </p>

        <h2 className="text-xl font-semibold text-gray-900 dark:text-white mt-8 mb-3">4. Security Measures</h2>
        <p className="text-sm text-gray-700 dark:text-gray-300 leading-relaxed mb-3">
          CashOS implements and maintains appropriate technical and organizational measures to protect Personal Data against unauthorized or unlawful processing, accidental loss, destruction, or damage. These measures include:
        </p>
        <ul className="list-disc list-inside text-sm text-gray-700 dark:text-gray-300 leading-relaxed space-y-1 ml-2">
        ...
        <p className="text-sm text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
          The Customer provides general authorization for CashOS to engage Sub-processors to assist in providing the Service. CashOS will notify the Customer of any intended changes to the list of Sub-processors at least 30 days before engaging a new Sub-processor. The Customer may object to such changes by providing written notice within 14 days; if the parties cannot resolve the objection, the Customer may terminate the affected Service. CashOS ensures that each Sub-processor is bound by data protection obligations no less protective than those set out in this DPA.
        </p>
        ...
        <p className="text-sm text-gray-700 dark:text-gray-300 leading-relaxed">
          CashOS and its Sub-processors primarily process data within the United States. Where Personal Data is transferred to a jurisdiction that does not provide an adequate level of data protection as determined by the European Commission or other relevant authority, CashOS ensures that appropriate safeguards are in place. These safeguards include Standard Contractual Clauses (SCCs) approved by the European Commission, supplemented by additional technical measures where necessary. CashOS will cooperate with the Customer to execute any additional transfer mechanism documentation required under applicable law.
        </p>

        <h2 className="text-xl font-semibold text-gray-900 dark:text-white mt-8 mb-3">7. Data Subject Rights</h2>
        <p className="text-sm text-gray-700 dark:text-gray-300 leading-relaxed">
          CashOS will assist the Customer in fulfilling its obligations to respond to Data Subject requests exercising their rights under applicable data protection laws, including rights of access, rectification, erasure, restriction, portability, and objection. If CashOS receives a request directly from a Data Subject, it will promptly redirect the request to the Customer unless legally prohibited from doing so. CashOS provides self-service data export and deletion functionality within the Service to facilitate the Customer's compliance with Data Subject requests. The Service also supports email unsubscribe requests, which are processed automatically and prevent further dunning communications to the opted-out Data Subject.
        </p>

        <h2 className="text-xl font-semibold text-gray-900 dark:text-white mt-8 mb-3">8. Data Breach Notification</h2>
        <p className="text-sm text-gray-700 dark:text-gray-300 leading-relaxed">
          In the event of a personal data breach that affects Customer Data, CashOS will notify the Customer without undue delay and in any event within 72 hours of becoming aware of the breach. The notification will include the nature of the breach, the categories and approximate number of Data Subjects affected, the likely consequences of the breach, and the measures taken or proposed to address the breach and mitigate its effects. CashOS will cooperate with the Customer and take reasonable commercial steps to assist in the investigation, mitigation, and remediation of the breach. CashOS will document all breaches, including the facts, effects, and corrective actions taken, and will make this documentation available to the Customer upon request.
        </p>

        <h2 className="text-xl font-semibold text-gray-900 dark:text-white mt-8 mb-3">9. Audits and Compliance</h2>
        <p className="text-sm text-gray-700 dark:text-gray-300 leading-relaxed">
          CashOS will make available to the Customer all information reasonably necessary to demonstrate compliance with the obligations set out in this DPA. Upon written request with at least 30 days' advance notice, the Customer may conduct or commission an independent auditor (bound by confidentiality obligations) to conduct an audit of CashOS's processing activities and security measures, no more than once per calendar year. CashOS will cooperate with such audits and provide reasonable access to relevant facilities, systems, and personnel. Where CashOS maintains relevant certifications or third-party audit reports (such as SOC 2 Type II), these may be provided in lieu of a direct audit at CashOS's discretion.
        </p>

        <h2 className="text-xl font-semibold text-gray-900 dark:text-white mt-8 mb-3">10. Data Retention and Deletion</h2>
        <p className="text-sm text-gray-700 dark:text-gray-300 leading-relaxed">
          Upon termination of the agreement between the Customer and CashOS, CashOS will, at the Customer's written election, return or delete all Personal Data processed on behalf of the Customer within 30 days, except where retention is required by applicable law or regulation. If the Customer does not provide instructions within 30 days of termination, CashOS will delete the Personal Data within 90 days of termination. CashOS will certify deletion in writing upon the Customer's request. Aggregated and anonymized data that cannot be used to identify any Data Subject is excluded from this deletion obligation.
        </p>

        <h2 className="text-xl font-semibold text-gray-900 dark:text-white mt-8 mb-3">11. Term and Termination</h2>
        <p className="text-sm text-gray-700 dark:text-gray-300 leading-relaxed">
          This DPA takes effect upon the Customer's acceptance of the Terms of Service and remains in effect for as long as CashOS processes Personal Data on behalf of the Customer. The obligations and rights of the Customer and CashOS under this DPA survive the termination of the DPA to the extent that CashOS continues to process or retain Personal Data on behalf of the Customer. In the event of a conflict between this DPA and the Terms of Service, this DPA shall prevail with respect to matters relating to the processing of Personal Data.
        </p>
        ...
        <p className="text-sm text-gray-700 dark:text-gray-300 leading-relaxed">
          For questions regarding this DPA or data processing matters, please contact our Data Protection Officer at dpo@recoverai.com or by mail at CashOS, Inc., 1209 Orange Street, Wilmington, DE 19801, United States.
        </p>
