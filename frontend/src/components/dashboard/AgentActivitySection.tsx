...
export const AgentActivitySection: React.FC<AgentActivitySectionProps> = ({
  ...
  return (
    <CollapsibleSection
      ...
      subtitle={`Ready to send ${preview.emailsWouldQueue} email${preview.emailsWouldQueue !== 1 ? 's' : ''} and offer ${preview.plansWouldOffer} payment plan${preview.plansWouldOffer !== 1 ? 's' : ''}`}
      icon={
      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
          {[
            ...
            { label: 'Payment plans', value: preview.plansWouldOffer, color: 'text-purple-600 dark:text-purple-400' },
