...
const RESULTS_FILE = path.join(__dirname, 'COMPREHENSIVE_TEST_CASES.md');
const PORT = 3000;
...
async function runAll() {
  ...
  await test('9.3 GET /api/payment-plans/list', 'GET', '/api/payment-plans/list', null, planCookie, 200);
